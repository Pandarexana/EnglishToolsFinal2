...
public class ingresoMT extends javax.swing.JFrame {
    ...
    private void btnDatosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDatosActionPerformed
        try {
            ...
            String rutaArchivo = "C://programa//puntuaciones//puntuacionesMT.txt";
        ...
        explodecorrecto();
        JOptionPane.showMessageDialog(null, "              "+ne+"/7\n          Aciertos", "", HEIGHT, iquiz);
        explodefin();
