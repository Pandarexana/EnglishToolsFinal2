...
import pantallas.topic4;


public class listeningMT extends javax.swing.JFrame {

 
    public listeningMT() {
        initComponents();
        this.setExtendedState(listeningMT.MAXIMIZED_BOTH);
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(btnSpeaking, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 224, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(btnSpeaking1, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 224, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(93, 93, 93)
    ...
    private void btnListeningActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnListeningActionPerformed
        File file=new File("C://programa//videos//math.mp4");
        System.out.println(file.isFile());
        Media media=new Media(file.toURI().toString());
         
        videoSeasonMT v = new videoSeasonMT(media);
        v.setVisible(true);
    ...
    private void btnSpeaking1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSpeaking1ActionPerformed
        speakingMT2 v = new speakingMT2();
        v.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_btnSpeaking1ActionPerformed

    private void btnRecordActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRecordActionPerformed
        puntuacionesMT punt = new puntuacionesMT();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new listeningMT().setVisible(true);
            }
        });
    }
