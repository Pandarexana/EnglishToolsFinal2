...
public class speakingMT24 extends javax.swing.JFrame implements ActionListener  {
    ...
    private void initComponents() {
        ...
        btnQP.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Simple Present Tense/quarter past.png"))); // NOI18N
        btnQP.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnQPActionPerformed(evt);
            }
        });
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        ...
                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                            .addGap(520, 520, 520)
                            .addComponent(btnQP, javax.swing.GroupLayout.PREFERRED_SIZE, 384, javax.swing.GroupLayout.PREFERRED_SIZE))))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(btnQP, javax.swing.GroupLayout.PREFERRED_SIZE, 257, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnAtrasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAtrasActionPerformed
        speakingMT23 ventanaListening = new speakingMT23();
    ...
    private void btnNextFallsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNextFallsActionPerformed
        speakingMT25 v = new speakingMT25();
        v.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_btnNextFallsActionPerformed

    private void btnQPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnQPActionPerformed
        
        explode();
        
    }//GEN-LAST:event_btnQPActionPerformed
   ...
   public void explode() {
   File sound = new File("C://programa//audio//quarter past.wav");
   try {
    ...
    public static void main(String args[])  {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new speakingMT24().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton btnQP;
