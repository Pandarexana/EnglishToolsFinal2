...
public class videoSeasonMT extends javax.swing.JFrame {
    ...
    public videoSeasonMT(Media file) {
        initComponents();
...
boolean estado = true;
    ...
    void asiganarTiempo() {
        try {
            ...
            Logger.getLogger(videoSeasonMT.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
