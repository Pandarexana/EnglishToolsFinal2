...
public class puntuacionesMT extends javax.swing.JFrame {

    
    public puntuacionesMT() {
        initComponents();
        cargarPuntuaciones();
...
tabla.setDefaultRenderer(Object.class, centerRenderer);
    ...
    String filePath = "C://programa//puntuaciones//puntuacionesMT.txt";
    ...
    private void btnCleanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCleanActionPerformed
        try {
            FileWriter escritor = new FileWriter("C://programa//puntuaciones//puntuacionesMT.txt");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new puntuacionesMT().setVisible(true);
            }
        });
    }
