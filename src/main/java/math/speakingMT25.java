...
public class speakingMT25 extends javax.swing.JFrame implements ActionListener  {
    ...
    private void initComponents() {
        ...
        btnQT.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Simple Present Tense/quarter to.png"))); // NOI18N
        btnQT.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnQTActionPerformed(evt);
            }
        });
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        ...
                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                            .addGap(520, 520, 520)
                            .addComponent(btnQT, javax.swing.GroupLayout.PREFERRED_SIZE, 384, javax.swing.GroupLayout.PREFERRED_SIZE))))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(btnQT, javax.swing.GroupLayout.PREFERRED_SIZE, 257, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnAtrasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAtrasActionPerformed
        speakingMT24 ventanaListening = new speakingMT24();
    ...
    private void btnQTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnQTActionPerformed
        
        explode();
        
    }//GEN-LAST:event_btnQTActionPerformed
 ...
 public void explodefin() {
   ...
   public void explode() {
   File sound = new File("C://programa//audio//quarter to.wav");
   try {
     Clip clip = AudioSystem.getClip();
     clip.open(AudioSystem.getAudioInputStream(sound)); // open the specified clip
     clip.start(); // play it
    ...
    public static void main(String args[])  {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new speakingMT25().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton btnQT;
