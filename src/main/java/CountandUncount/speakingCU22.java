 ...
 * @author Pandarexana
 */
public class speakingCU22 extends javax.swing.JFrame implements ActionListener  {
    ...
    private void initComponents() {
        ...
        btnOil = new javax.swing.JButton();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
        setTitle("Countable and uncountable nouns - Speaking 2");
        ...
        btnOil.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Eating Healthy/oil.jpg"))); // NOI18N
        btnOil.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnOilActionPerformed(evt);
            }
        });
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(520, 520, 520)
                        .addComponent(btnOil, javax.swing.GroupLayout.PREFERRED_SIZE, 384, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(btnOil, javax.swing.GroupLayout.PREFERRED_SIZE, 257, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnAtrasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAtrasActionPerformed
        speakingCU21 ventanaListening = new speakingCU21();
    ...
    private void btnNextFallsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNextFallsActionPerformed
        speakingCU23 v = new speakingCU23();
        v.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_btnNextFallsActionPerformed

    private void btnOilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOilActionPerformed
        
        explode();
        
    }//GEN-LAST:event_btnOilActionPerformed
   ...
   public void explode() {
   File sound = new File("C://programa//audio//oil.wav");
   try {
    ...
    public static void main(String args[])  {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new speakingCU22().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton btnOil;
