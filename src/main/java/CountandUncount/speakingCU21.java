 ...
 * @author Pandarexana
 */
public class speakingCU21 extends javax.swing.JFrame implements ActionListener  {
    ...
    private void initComponents() {
        ...
        btnMilk.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Eating Healthy/milk.jpg"))); // NOI18N
    ...
    private void btnAtrasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAtrasActionPerformed
        speakingCU2 ventanaListening = new speakingCU2();
    ...
    private void btnNextFallsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNextFallsActionPerformed
        speakingCU22 v = new speakingCU22();
        v.setVisible(true);
        this.dispose();
   ...
   try {
    ...
    public static void main(String args[])  {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new speakingCU21().setVisible(true);
            }
        });
    }
