...
public class ingresoCU extends javax.swing.JFrame {
    ...
    private void btnDatosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDatosActionPerformed
        try {
            ...
            String rutaArchivo = "C://programa//puntuaciones//puntuacionesCU.txt";
        ...
        explodecorrecto();
        JOptionPane.showMessageDialog(null, "              "+ne+"/12\n          Aciertos", "", HEIGHT, iquiz);
        explodefin();
        JOptionPane.showMessageDialog(null, "Quiz completed!", "", HEIGHT, smile);
        
        listeningCU k = new listeningCU();
        k.setVisible(true);
        this.dispose();
        quizCU3 kk = new quizCU3();
        kk.dispose();
