 ...
 * @author Pandarexana
 */
public class speakingCU1 extends javax.swing.JFrame implements ActionListener  {
    ...
    private void initComponents() {
        ...
        btnLemon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Eating Healthy/lemon.jpg"))); // NOI18N
    ...
    private void btnNextFallsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNextFallsActionPerformed
        speakingCU11 v = new speakingCU11();
        v.setVisible(true);
        this.dispose();
   ...
   public void explode() {
   File sound = new File("C://programa//audio//lemon.wav");
   try {
    ...
    public static void main(String args[])  {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new speakingCU1().setVisible(true);
            }
        });
    }
