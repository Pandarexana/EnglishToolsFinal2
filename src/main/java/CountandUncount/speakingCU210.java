 ...
 * @author Pandarexana
 */
public class speakingCU210 extends javax.swing.JFrame implements ActionListener  {
   

    Icon speaking;
    
    public speakingCU210() {
        initComponents();
    ...
    private void initComponents() {
        ...
        btnWater.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Eating Healthy/water.jpg"))); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(518, 518, 518)
                        .addComponent(btnWater, javax.swing.GroupLayout.PREFERRED_SIZE, 384, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGap(24, 24, 24)
                .addComponent(btnWater, javax.swing.GroupLayout.PREFERRED_SIZE, 257, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnAtrasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAtrasActionPerformed
        speakingCU29 ventanaListening = new speakingCU29();
   ...
   public void explode() {
   File sound = new File("C://programa//audio//water.wav");
   try {
   ...
   try {
    ...
    public static void main(String args[])  {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new speakingCU210().setVisible(true);
            }
        });
    }
