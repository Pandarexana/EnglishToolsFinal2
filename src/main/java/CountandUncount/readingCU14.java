...
public class readingCU14 extends javax.swing.JFrame {
    ...
    public readingCU14() {
        initComponents();
        this.setExtendedState(readingCU14.MAXIMIZED_BOTH);
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Wich is countable noun ?");

        btnOpen.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Eating Healthy/imagenes pequenas/cereal.png"))); // NOI18N
        ...
        btnClose.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Eating Healthy/imagenes pequenas/cheese.png"))); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(438, 438, 438)
                        .addComponent(btnClose, javax.swing.GroupLayout.PREFERRED_SIZE, 249, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(61, 61, 61)
    ...
    private void btnAtrasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAtrasActionPerformed
        readingCU13 ventanaListening = new readingCU13();
   ...
   try {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new readingCU14().setVisible(true);
            }
        });
    }
