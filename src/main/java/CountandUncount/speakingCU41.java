 ...
 * @author Pandarexana
 */
public class speakingCU41 extends javax.swing.JFrame implements ActionListener  {
    ...
    private void initComponents() {
        ...
        btnSeparateFood = new javax.swing.JButton();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
        setTitle("Countable and uncountable nouns - Speaking 4");
        ...
        btnSeparateFood.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Eating Healthy/separate food.jpg"))); // NOI18N
        btnSeparateFood.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnSeparateFoodActionPerformed(evt);
            }
        });
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(518, 518, 518)
                        .addComponent(btnSeparateFood, javax.swing.GroupLayout.PREFERRED_SIZE, 384, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(610, 610, 610)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGap(24, 24, 24)
                .addComponent(btnSeparateFood, javax.swing.GroupLayout.PREFERRED_SIZE, 257, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnAtrasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAtrasActionPerformed
        speakingCU4 ventanaListening = new speakingCU4();
    ...
    private void btnNextFallsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNextFallsActionPerformed
        speakingCU42 v = new speakingCU42();
        v.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_btnNextFallsActionPerformed

    private void btnSeparateFoodActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSeparateFoodActionPerformed
        
        explode();
        
    }//GEN-LAST:event_btnSeparateFoodActionPerformed
   ...
   public void explode() {
   File sound = new File("C://programa//audio//separate food.wav");
   try {
    ...
    public static void main(String args[])  {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new speakingCU41().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton btnSeparateFood;
