...
public class readingCU1 extends javax.swing.JFrame {
    ...
    public readingCU1() {
        initComponents();
        this.setExtendedState(readingCU1.MAXIMIZED_BOTH);
    ...
    private void initComponents() {
        ...
        btnOpen.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Eating Healthy/imagenes pequenas/milk.png"))); // NOI18N
        ...
        btnClose.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Eating Healthy/imagenes pequenas/apple.png"))); // NOI18N
   ...
   try {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new readingCU1().setVisible(true);
            }
        });
    }
