...
import pantallas.topic2;


public class listeningCU extends javax.swing.JFrame {

 
    public listeningCU() {
        initComponents();
        this.setExtendedState(listeningCU.MAXIMIZED_BOTH);
    ...
    private void initComponents() {
        ...
        btnSpeaking3 = new javax.swing.JButton();
        jLabel5 = new javax.swing.JLabel();
        btnRecord = new javax.swing.JButton();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
        setTitle("Countable and uncountable nouns");
        ...
        btnSpeaking3.setBackground(new java.awt.Color(51, 153, 255));
        btnSpeaking3.setFont(new java.awt.Font("Segoe Print", 1, 24)); // NOI18N
        btnSpeaking3.setText("Speaking 4");
        btnSpeaking3.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED, null, java.awt.Color.black, null, java.awt.Color.black));
        btnSpeaking3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnSpeaking3ActionPerformed(evt);
            }
        });
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(btnSpeaking3, javax.swing.GroupLayout.PREFERRED_SIZE, 224, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(93, 93, 93)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addComponent(btnSpeaking3, javax.swing.GroupLayout.PREFERRED_SIZE, 88, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnListeningActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnListeningActionPerformed
        File file=new File("C://programa//videos//count.mp4");
        System.out.println(file.isFile());
        Media media=new Media(file.toURI().toString());
         
        videoSeasonCU v = new videoSeasonCU(media);
        v.setVisible(true);
    ...
    private void btnSpeaking2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSpeaking2ActionPerformed
        speakingCU3 v = new speakingCU3();
        v.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_btnSpeaking2ActionPerformed

    private void btnSpeaking3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSpeaking3ActionPerformed
        speakingCU4 v = new speakingCU4();
        v.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_btnSpeaking3ActionPerformed

    private void btnRecordActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRecordActionPerformed
        puntuacionesCU punt = new puntuacionesCU();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new listeningCU().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton btnSpeaking3;
