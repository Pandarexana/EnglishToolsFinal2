...
public class readingCU11 extends javax.swing.JFrame {
    ...
    public readingCU11() {
        initComponents();
        this.setExtendedState(readingCU11.MAXIMIZED_BOTH);
    ...
    private void initComponents() {
        ...
        btnOpen.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Eating Healthy/imagenes pequenas/bread.png"))); // NOI18N
        ...
        btnClose.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Eating Healthy/imagenes pequenas/oil.png"))); // NOI18N
    ...
    private void btnAtrasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAtrasActionPerformed
        readingCU1 ventanaListening = new readingCU1();
   ...
   try {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new readingCU11().setVisible(true);
            }
        });
    }
