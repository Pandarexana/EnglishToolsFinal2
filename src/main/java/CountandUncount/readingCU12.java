...
public class readingCU12 extends javax.swing.JFrame {
    ...
    public readingCU12() {
        initComponents();
        this.setExtendedState(readingCU12.MAXIMIZED_BOTH);
    ...
    private void initComponents() {
        ...
        btnOpen.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Eating Healthy/imagenes pequenas/sugar.png"))); // NOI18N
        ...
        btnClose.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Eating Healthy/imagenes pequenas/carrot.png"))); // NOI18N
    ...
    private void btnAtrasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAtrasActionPerformed
        readingCU11 ventanaListening = new readingCU11();
   ...
   try {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new readingCU12().setVisible(true);
            }
        });
    }
