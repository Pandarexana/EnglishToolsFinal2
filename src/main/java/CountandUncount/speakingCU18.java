 ...
 * @author Pandarexana
 */
public class speakingCU18 extends javax.swing.JFrame implements ActionListener  {
    ...
    private void initComponents() {
        ...
        btnBanana.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Eating Healthy/banana.jpg"))); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(520, 520, 520)
                        .addComponent(btnBanana, javax.swing.GroupLayout.PREFERRED_SIZE, 384, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(btnBanana, javax.swing.GroupLayout.PREFERRED_SIZE, 257, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnAtrasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAtrasActionPerformed
        speakingCU17 ventanaListening = new speakingCU17();
    ...
    private void btnNextFallsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNextFallsActionPerformed
        speakingCU19 v = new speakingCU19();
        v.setVisible(true);
        this.dispose();
   ...
   public void explode() {
   File sound = new File("C://programa//audio//banana.wav");
   try {
    ...
    public static void main(String args[])  {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new speakingCU18().setVisible(true);
            }
        });
    }
