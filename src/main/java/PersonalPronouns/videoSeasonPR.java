...
public class videoSeasonPR extends javax.swing.JFrame {
    ...
    public videoSeasonPR(Media file) {
        initComponents();
...
boolean estado = true;
    ...
    void asiganarTiempo() {
        try {
            ...
            Logger.getLogger(videoSeasonPR.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
