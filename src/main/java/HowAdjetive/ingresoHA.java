...
public class ingresoHA extends javax.swing.JFrame {
    ...
    private void btnDatosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDatosActionPerformed
        try {
            ...
            String rutaArchivo = "C://programa//puntuaciones//puntuacionesHA.txt";
        ...
        listeningHA k = new listeningHA();
        k.setVisible(true);
        this.dispose();
        quizHA2 kk = new quizHA2();
        kk.dispose();
