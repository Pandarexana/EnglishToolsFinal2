...
public class videoSeasonHA extends javax.swing.JFrame {
    ...
    public videoSeasonHA(Media file) {
        initComponents();
...
boolean estado = true;
    ...
    void asiganarTiempo() {
        try {
            ...
            Logger.getLogger(videoSeasonHA.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
