...
public class readingSC2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Farm animals/help-farmer-horse.jpg"))); // NOI18N
        ...
        jLabel8.setText(" / helps farmers to herd cattle.");
    ...
    private void btnCheckMEActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCheckMEActionPerformed
        ...
        if (s11.equalsIgnoreCase("Riding")){
            ...
            readingSC22 me = new readingSC22();
            me.setVisible(true);
            this.dispose();
   ...
   try {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new readingSC2().setVisible(true);
            }
        });
    }
