...
public class videoSeasonSC extends javax.swing.JFrame {
  ...
  @Override
    ...
    public videoSeasonSC(Media file) {
        initComponents();
...
boolean estado = true;
    ...
    void asiganarTiempo() {
        try {
            ...
            Logger.getLogger(videoSeasonSC.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
