...
public class puntuacionesSC extends javax.swing.JFrame {

    
    public puntuacionesSC() {
        initComponents();
        cargarPuntuaciones();
...
tabla.setDefaultRenderer(Object.class, centerRenderer);
    ...
    String filePath = "C://programa//puntuaciones//puntuacionesSC.txt";
    ...
    private void btnCleanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCleanActionPerformed
        try {
            FileWriter escritor = new FileWriter("C://programa//puntuaciones//puntuacionesSC.txt");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new puntuacionesSC().setVisible(true);
            }
        });
    }
