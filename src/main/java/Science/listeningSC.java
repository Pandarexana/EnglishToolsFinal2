...
public class listeningSC extends javax.swing.JFrame {

 
    public listeningSC() {
        initComponents();
        this.setExtendedState(listeningSC.MAXIMIZED_BOTH);
    ...
    private void btnListeningActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnListeningActionPerformed
        File file=new File("C://programa//videos//science.mp4");
        System.out.println(file.isFile());
        Media media=new Media(file.toURI().toString());
         
        videoSeasonSC v = new videoSeasonSC(media);
        v.setVisible(true);
    ...
    private void btnReading1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnReading1ActionPerformed
        readingSC2 x = new readingSC2();
        x.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_btnReading1ActionPerformed

    private void btnRecordActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRecordActionPerformed
        puntuacionesSC punt = new puntuacionesSC();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new listeningSC().setVisible(true);
            }
        });
    }
