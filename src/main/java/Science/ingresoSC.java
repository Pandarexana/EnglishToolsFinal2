...
public class ingresoSC extends javax.swing.JFrame {
    ...
    private void btnDatosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDatosActionPerformed
        try {
            ...
            String rutaArchivo = "C://programa//puntuaciones//puntuacionesSC.txt";
        ...
        explodecorrecto();
        JOptionPane.showMessageDialog(null, "              "+ne+"/4\n          Aciertos", "", HEIGHT, iquiz);
        explodefin();
        JOptionPane.showMessageDialog(null, "Quiz completed!", "", HEIGHT, smile);
        
        listeningSC k = new listeningSC();
        k.setVisible(true);
        quizSC kk = new quizSC();
        kk.dispose();
        this.dispose();
