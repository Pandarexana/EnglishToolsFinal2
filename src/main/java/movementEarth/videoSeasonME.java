...
public class videoSeasonME extends javax.swing.JFrame {
  ...
  @Override
    ...
    public videoSeasonME(Media file) {
        initComponents();
...
boolean estado = true;
    ...
    void asiganarTiempo() {
        try {
            ...
            Logger.getLogger(videoSeasonME.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
