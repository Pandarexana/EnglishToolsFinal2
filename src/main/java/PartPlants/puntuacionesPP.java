...
public class puntuacionesPP extends javax.swing.JFrame {

    
    public puntuacionesPP() {
        initComponents();
        cargarPuntuaciones();
...
tabla.setDefaultRenderer(Object.class, centerRenderer);
    ...
    String filePath = "C://programa//puntuaciones//puntuacionesPP.txt";
    ...
    private void initComponents() {
        ...
        setTitle("Record - Parts of Plants");
    ...
    private void btnCleanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCleanActionPerformed
        try {
            FileWriter escritor = new FileWriter("C://programa//puntuaciones//puntuacionesPP.txt");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new puntuacionesPP().setVisible(true);
            }
        });
    }
