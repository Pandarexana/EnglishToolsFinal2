...
public class videoSeasonPP extends javax.swing.JFrame {
    ...
    public videoSeasonPP(Media file) {
        initComponents();
...
boolean estado = true;
    ...
    void asiganarTiempo() {
        try {
            ...
            Logger.getLogger(videoSeasonPP.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
