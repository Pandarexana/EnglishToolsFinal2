...
import static seasons.quiz1.xy;


public class ingresoPP extends javax.swing.JFrame {
    ...
    private void btnDatosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDatosActionPerformed
        try {
            ...
            String rutaArchivo = "C://programa//puntuaciones//puntuacionesPP.txt";
        ...
        explodecorrecto();
        JOptionPane.showMessageDialog(null, "              "+ne+"/10\n          Aciertos", "", HEIGHT, iquiz);
        explodefin();
        JOptionPane.showMessageDialog(null, "Quiz completed!", "", HEIGHT, smile);
        
        listeningPP k = new listeningPP();
        k.setVisible(true);
        this.dispose();
        quizPP2 kk = new quizPP2();
        kk.dispose();
