...
public class ingresoFA extends javax.swing.JFrame {
    ...
    private void btnDatosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDatosActionPerformed
        try {
            ...
            String rutaArchivo = "C://programa//puntuaciones//puntuacionesFA.txt";
        ...
        explodecorrecto();
        JOptionPane.showMessageDialog(null, "              "+ne+"/13\n          Aciertos", "", HEIGHT, iquiz);
        explodefin();
