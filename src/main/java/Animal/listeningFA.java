...
public class listeningFA extends javax.swing.JFrame {

 
    public listeningFA() {
        initComponents();
        this.setExtendedState(listeningFA.MAXIMIZED_BOTH);
    ...
    private void btnListeningActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnListeningActionPerformed
        File file=new File("C://programa//videos//animals.mp4");
        System.out.println(file.isFile());
        Media media=new Media(file.toURI().toString());
         
        videoSeasonFA v = new videoSeasonFA(media);
        v.setVisible(true);
    ...
    private void btnSpeaking2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSpeaking2ActionPerformed
        speakingFA3 v = new speakingFA3();
        v.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_btnSpeaking2ActionPerformed

    private void btnRecordActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRecordActionPerformed
        puntuacionesFA punt = new puntuacionesFA();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new listeningFA().setVisible(true);
            }
        });
    }
