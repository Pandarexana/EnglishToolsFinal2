...
public class speakingFA3 extends javax.swing.JFrame implements ActionListener  {
    ...
    private void initComponents() {
        ...
        btnOx.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Farm animals/ox.jpg"))); // NOI18N
    ...
    private void btnNextFallsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNextFallsActionPerformed
        speakingFA32 v = new speakingFA32();
        v.setVisible(true);
        this.dispose();
   ...
   public void explode() {
   File sound = new File("C://programa//audio//ox.wav");
   try {
    ...
    public static void main(String args[])  {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new speakingFA3().setVisible(true);
            }
        });
    }
