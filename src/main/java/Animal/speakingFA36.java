...
public class speakingFA36 extends javax.swing.JFrame implements ActionListener  {
    ...
    private void initComponents() {
        ...
        btnPuppy = new javax.swing.JButton();
        ...
        btnPuppy.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Farm animals/puppy.jpg"))); // NOI18N
        btnPuppy.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnPuppyActionPerformed(evt);
            }
        });
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(520, 520, 520)
                        .addComponent(btnPuppy, javax.swing.GroupLayout.PREFERRED_SIZE, 384, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(btnPuppy, javax.swing.GroupLayout.PREFERRED_SIZE, 257, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnAtrasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAtrasActionPerformed
        speakingFA35 ventanaListening = new speakingFA35();
    ...
    private void btnNextFallsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNextFallsActionPerformed
        speakingFA37 v = new speakingFA37();
        v.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_btnNextFallsActionPerformed

    private void btnPuppyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPuppyActionPerformed
        
        explode();
        
    }//GEN-LAST:event_btnPuppyActionPerformed
   ...
   public void explode() {
   File sound = new File("C://programa//audio//puppy.wav");
   try {
    ...
    public static void main(String args[])  {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new speakingFA36().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton btnPuppy;
