 ...
 * @author Pandarexana
 */
public class speakingMC15 extends javax.swing.JFrame implements ActionListener  {
    ...
    private void initComponents() {
        ...
        btnFall.setIcon(new javax.swing.ImageIcon(getClass().getResource("/City/inside.jpg"))); // NOI18N
    ...
    private void btnAtrasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAtrasActionPerformed
        speakingMC14 ventanaListening = new speakingMC14();
    ...
    private void btnNextFallsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNextFallsActionPerformed
        speakingMC16 v = new speakingMC16();
        v.setVisible(true);
        this.dispose();
   ...
   public void explode() {
   File sound = new File("C://programa//audio//inside.wav");
   try {
    ...
    public static void main(String args[])  {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new speakingMC15().setVisible(true);
            }
        });
    }
