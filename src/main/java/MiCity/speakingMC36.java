 ...
 * @author Pandarexana
 */
public class speakingMC36 extends javax.swing.JFrame implements ActionListener  {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Police Station");
        ...
        btnFall.setIcon(new javax.swing.ImageIcon(getClass().getResource("/City/police station.jpg"))); // NOI18N
    ...
    private void btnAtrasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAtrasActionPerformed
        speakingMC35 ventanaListening = new speakingMC35();
    ...
    private void btnNextFallsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNextFallsActionPerformed
        speakingMC37 v = new speakingMC37();
        v.setVisible(true);
        this.dispose();
   ...
   try {
    ...
    public static void main(String args[])  {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new speakingMC36().setVisible(true);
            }
        });
    }
