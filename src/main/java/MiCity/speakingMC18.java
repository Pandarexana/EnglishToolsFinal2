 ...
 * @author Pandarexana
 */
public class speakingMC18 extends javax.swing.JFrame implements ActionListener  {
    ...
    private void initComponents() {
        ...
        btnFall.setIcon(new javax.swing.ImageIcon(getClass().getResource("/City/under.jpg"))); // NOI18N
    ...
    private void btnAtrasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAtrasActionPerformed
        speakingMC17 ventanaListening = new speakingMC17();
   ...
   public void explode() {
   File sound = new File("C://programa//audio//under.wav");
   try {
   ...
   try {
    ...
    public static void main(String args[])  {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new speakingMC18().setVisible(true);
            }
        });
    }
