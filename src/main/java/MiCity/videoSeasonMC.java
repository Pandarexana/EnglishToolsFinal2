...
public class videoSeasonMC extends javax.swing.JFrame {
  ...
  @Override
    ...
    public videoSeasonMC(Media file) {
        initComponents();
...
boolean estado = true;
    ...
    void asiganarTiempo() {
        try {
            ...
            Logger.getLogger(videoSeasonMC.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
