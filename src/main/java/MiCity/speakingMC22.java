 ...
 * @author Pandarexana
 */
public class speakingMC22 extends javax.swing.JFrame implements ActionListener  {
    ...
    private void initComponents() {
        ...
        setTitle("Prepositions of Place - Speaking 2");
        ...
        btnFall.setIcon(new javax.swing.ImageIcon(getClass().getResource("/City/turn rigth.jpg"))); // NOI18N
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(btnFall, javax.swing.GroupLayout.PREFERRED_SIZE, 257, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnAtrasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAtrasActionPerformed
        speakingMC21 ventanaListening = new speakingMC21();
    ...
    private void btnNextFallsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNextFallsActionPerformed
        speakingMC23 v = new speakingMC23();
        v.setVisible(true);
        this.dispose();
   ...
   public void explode() {
   File sound = new File("C://programa//audio//turn right.wav");
   try {
    ...
    public static void main(String args[])  {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new speakingMC22().setVisible(true);
            }
        });
    }
