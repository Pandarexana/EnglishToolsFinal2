 ...
 * @author Pandarexana
 */
public class speakingMC34 extends javax.swing.JFrame implements ActionListener  {
    ...
    private void initComponents() {
        ...
        setTitle("Prepositions of Place - Speaking 3");
        ...
        btnFall.setIcon(new javax.swing.ImageIcon(getClass().getResource("/City/mall.jpg"))); // NOI18N
    ...
    private void btnAtrasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAtrasActionPerformed
        speakingMC33 ventanaListening = new speakingMC33();
    ...
    private void btnNextFallsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNextFallsActionPerformed
        speakingMC35 v = new speakingMC35();
        v.setVisible(true);
        this.dispose();
   ...
   public void explode() {
   File sound = new File("C://programa//audio//mall.wav");
   try {
    ...
    public static void main(String args[])  {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new speakingMC34().setVisible(true);
            }
        });
    }
