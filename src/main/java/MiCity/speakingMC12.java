 ...
 * @author Pandarexana
 */
public class speakingMC12 extends javax.swing.JFrame implements ActionListener  {
    ...
    private void initComponents() {
        ...
        btnFall.setIcon(new javax.swing.ImageIcon(getClass().getResource("/City/behind.jpg"))); // NOI18N
    ...
    private void btnAtrasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAtrasActionPerformed
        speakingMC1 ventanaListening = new speakingMC1();
    ...
    private void btnNextFallsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNextFallsActionPerformed
        speakingMC13 v = new speakingMC13();
        v.setVisible(true);
        this.dispose();
   ...
   public void explode() {
   File sound = new File("C://programa//audio//behind.wav");
   try {
    ...
    public static void main(String args[])  {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new speakingMC12().setVisible(true);
            }
        });
    }
