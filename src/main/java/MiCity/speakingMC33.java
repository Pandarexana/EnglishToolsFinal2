 ...
 * @author Pandarexana
 */
public class speakingMC33 extends javax.swing.JFrame implements ActionListener  {
    ...
    private void initComponents() {
        ...
        btnFall.setIcon(new javax.swing.ImageIcon(getClass().getResource("/City/library.png"))); // NOI18N
    ...
    private void btnAtrasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAtrasActionPerformed
        speakingMC32 ventanaListening = new speakingMC32();
    ...
    private void btnNextFallsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNextFallsActionPerformed
        speakingMC34 v = new speakingMC34();
        v.setVisible(true);
        this.dispose();
   ...
   public void explode() {
   File sound = new File("C://programa//audio//library.wav");
   try {
    ...
    public static void main(String args[])  {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new speakingMC33().setVisible(true);
            }
        });
    }
