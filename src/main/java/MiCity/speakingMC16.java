 ...
 * @author Pandarexana
 */
public class speakingMC16 extends javax.swing.JFrame implements ActionListener  {
    ...
    private void initComponents() {
        ...
        setTitle("Prepositions of Place - Speaking 1");
        ...
        btnFall.setIcon(new javax.swing.ImageIcon(getClass().getResource("/City/next to.jpg"))); // NOI18N
    ...
    private void btnAtrasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAtrasActionPerformed
        speakingMC15 ventanaListening = new speakingMC15();
    ...
    private void btnNextFallsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNextFallsActionPerformed
        speakingMC17 v = new speakingMC17();
        v.setVisible(true);
        this.dispose();
   ...
   public void explode() {
   File sound = new File("C://programa//audio//next to.wav");
   try {
    ...
    public static void main(String args[])  {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new speakingMC16().setVisible(true);
            }
        });
    }
