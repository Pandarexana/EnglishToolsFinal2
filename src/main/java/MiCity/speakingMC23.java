 ...
 * @author Pandarexana
 */
public class speakingMC23 extends javax.swing.JFrame implements ActionListener  {
    ...
    private void initComponents() {
        ...
        btnFall.setIcon(new javax.swing.ImageIcon(getClass().getResource("/City/u turn.jpg"))); // NOI18N
    ...
    private void btnAtrasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAtrasActionPerformed
        speakingMC22 ventanaListening = new speakingMC22();
   ...
   public void explode() {
   File sound = new File("C://programa//audio//u turn.wav");
   try {
   ...
   try {
    ...
    public static void main(String args[])  {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new speakingMC23().setVisible(true);
            }
        });
    }
