...
public class ventanaPrincipal extends javax.swing.JFrame {
    ...
    public ventanaPrincipal() {
        ...
        hello = new ImageIcon("C://programa//imagenes//hello.png");
    }
    ...
    private void initComponents() {
        ...
        setBackground(new java.awt.Color(253, 253, 105));
        ...
        jLabel5.setText("Welcome to the JM English tool !!!");

        btnLogin.setBackground(new java.awt.Color(51, 153, 255));
        btnLogin.setFont(new java.awt.Font("Segoe Print", 1, 36)); // NOI18N
        ...
        btnExit.setFont(new java.awt.Font("Segoe Print", 1, 36)); // NOI18N
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes pantallas/assd (1).png"))); // NOI18N
        jLabel1.setText("jLabel1");

        jLabel2.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel2.setText("© Creado por Justin Macías Vélez. Estudiante de Ingenieria de Sistemas. Facultad de Ciencias de la Vida y Tecnología. Universidad Laica Eloy Alfaro de Manabí.");
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        explode();
        JOptionPane.showMessageDialog(null, "     Welcome ", "", HEIGHT, hello);
    ...
    public void explode() {
   File sound = new File("C://programa//audio//welcome.wav");
   try {
