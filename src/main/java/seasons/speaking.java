...
public class speaking extends javax.swing.JFrame implements ActionListener  {
    ...
    private void initComponents() {
        ...
        btnFall.setIcon(new javax.swing.ImageIcon(getClass().getResource("/otoño.png"))); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(520, 520, 520)
                        .addComponent(btnFall, javax.swing.GroupLayout.PREFERRED_SIZE, 384, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(btnFall, javax.swing.GroupLayout.PREFERRED_SIZE, 263, javax.swing.GroupLayout.PREFERRED_SIZE)
   ...
   /* private void reconocerPalabra() {
        System.out.println("Escuchando...");
        SpeechResult result = recognizer.getResult();

        if (result != null) {
            String palabra = result.getHypothesis();

            if (palabra.equals("hola")) {
                System.out.println("Se ha reconocido la palabra 'hola'");
    ...
    private void formWindowClosing(java.awt.event.WindowEvent evt) {                                   
        // Liberar los recursos utilizados por el reconocedor de voz
        recognizer.stopRecognition();
        //recognizer1.dispose();
    }  */     
   ...
   public void explode() {
   File sound = new File("C://programa//audio//Fall2.wav");
   try {
