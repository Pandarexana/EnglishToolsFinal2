...
public class puntuacionesSeasons extends javax.swing.JFrame {

    
    public puntuacionesSeasons() {
        initComponents();
        cargarPuntuaciones();
...
tabla.setDefaultRenderer(Object.class, centerRenderer);
    ...
    String filePath = "C://programa//puntuaciones//puntuacionesSeasons.txt";
    ...
    private void btnCleanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCleanActionPerformed
        try {
            FileWriter escritor = new FileWriter("C://programa//puntuaciones//puntuacionesSeasons.txt");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new puntuacionesSeasons().setVisible(true);
            }
        });
    }
