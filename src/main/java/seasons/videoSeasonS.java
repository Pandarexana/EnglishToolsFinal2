...
public class videoSeasonS extends javax.swing.JFrame {
  ...
  @Override
    ...
    public videoSeasonS(Media file) {
        initComponents();
        Media video = new Media(new File("C://programa//videos//seasons.mp4").toURI().toString());
        createScene(file);
    ...
    private void createScene(Media video) {
        Platform.runLater(new Runnable() {
            @Override
            public void run() {
                StackPane root = new StackPane();
                oracleVid = new MediaPlayer(video);
...
boolean estado = true;
    ...
    void asiganarTiempo() {
        try {
            ...
            Logger.getLogger(videoSeasonS.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
