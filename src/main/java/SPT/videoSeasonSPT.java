...
public class videoSeasonSPT extends javax.swing.JFrame {
    ...
    public videoSeasonSPT(Media file) {
        initComponents();
...
boolean estado = true;
    ...
    void asiganarTiempo() {
        try {
            ...
            Logger.getLogger(videoSeasonSPT.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
