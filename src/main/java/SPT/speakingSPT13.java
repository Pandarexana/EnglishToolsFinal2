...
public class speakingSPT13 extends javax.swing.JFrame implements ActionListener  {
   

    
    public speakingSPT13() {
        initComponents();
    ...
    private void initComponents() {
        ...
        btnWU.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Simple Present Tense/wake up.png"))); // NOI18N
        btnWU.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnWUActionPerformed(evt);
            }
        });
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(520, 520, 520)
                        .addComponent(btnWU, javax.swing.GroupLayout.PREFERRED_SIZE, 384, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(635, 635, 635)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(btnWU, javax.swing.GroupLayout.PREFERRED_SIZE, 257, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnAtrasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAtrasActionPerformed
        speakingSPT12 ventanaListening = new speakingSPT12();
    ...
    private void btnNextFallsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNextFallsActionPerformed
        speakingSPT14 v = new speakingSPT14();
        v.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_btnNextFallsActionPerformed

    private void btnWUActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnWUActionPerformed
        
        explode();
        
    }//GEN-LAST:event_btnWUActionPerformed
   ...
   public void explode() {
   File sound = new File("C://programa//audio//wake up.wav");
   try {
    ...
    public static void main(String args[])  {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new speakingSPT13().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton btnWU;
