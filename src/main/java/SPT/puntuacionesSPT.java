...
public class puntuacionesSPT extends javax.swing.JFrame {

    
    public puntuacionesSPT() {
        initComponents();
        cargarPuntuaciones();
...
tabla.setDefaultRenderer(Object.class, centerRenderer);
    ...
    String filePath = "C://programa//puntuaciones//puntuacionesSPT.txt";
    ...
    private void initComponents() {
        ...
        setTitle("Record - Simple Present Tense");
    ...
    private void btnCleanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCleanActionPerformed
        try {
            FileWriter escritor = new FileWriter("C://programa//puntuaciones//puntuacionesSPT.txt");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new puntuacionesSPT().setVisible(true);
            }
        });
    }
