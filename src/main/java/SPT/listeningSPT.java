...
public class listeningSPT extends javax.swing.JFrame {

 
    public listeningSPT() {
        initComponents();
        this.setExtendedState(listeningSPT.MAXIMIZED_BOTH);
    ...
    private void btnListeningActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnListeningActionPerformed
        File file=new File("C://programa//videos//spt.mp4");
        System.out.println(file.isFile());
        Media media=new Media(file.toURI().toString());
         
        videoSeasonSPT v = new videoSeasonSPT(media);
        v.setVisible(true);
    ...
    private void btnReading1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnReading1ActionPerformed
        readingSPT2 x = new readingSPT2();
        x.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_btnReading1ActionPerformed

    private void btnRecordActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRecordActionPerformed
        puntuacionesSPT punt = new puntuacionesSPT();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new listeningSPT().setVisible(true);
            }
        });
    }
